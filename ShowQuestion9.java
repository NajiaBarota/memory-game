...
import javax.swing.*;
 ...
 public class ShowQuestion9 extends JFrame{
 ...
 public Font f;
  private JTextArea ta1;
     ...
     public void initComponents()
    {
     ...
     label1=new JLabel();
     label1.setText("What is the sequence number of Rubik's Cube?"); 
     c.add(label1);
    ...
    btn1.setBounds(820, 580, 100, 30);
     ...
     public static void main(String[] args) {
       ...
       ShowQuestion9  frame = new ShowQuestion9();

...
import javax.swing.*;
 ...
 public class ShowQuestion5 extends JFrame{
 ...
 public Font f;
  private JTextArea ta1;
     ...
     public void initComponents()
    {
     ...
     label1=new JLabel();
     label1.setText("What is the sequence number of Dragon Fruit?"); 
     c.add(label1);
    ...
    btn1.setBounds(820, 580, 100, 30);
     c.add(btn1);
       ...
       public void actionPerformed(ActionEvent ae) {
           ...
           {
           dispose();
           ShowQuestion4 frame = new ShowQuestion4();
           frame.setVisible(true);

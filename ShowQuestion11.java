...
import javax.swing.*;
 ...
 public class ShowQuestion11 extends JFrame{
 ...
 public Font f;
  private JTextArea ta1;
     ...
     public void initComponents()
    {
     ...
     label1=new JLabel();
     label1.setText("What is the sequence number of Great Wall of China?"); 
     c.add(label1);
    ...
    btn2.setBounds(40, 580, 100, 30);
     ...
     c.add(label2);
     label2.setBounds(500,560,580,50);
    ...
    btn1.setBounds(820, 580, 100, 30);
     c.add(btn1);
       ...
       public void actionPerformed(ActionEvent ae) {
           ...
           {
           dispose();
           ShowQuestion8 frame = new ShowQuestion8();
       ...
       public void actionPerformed(ActionEvent ae) {
           ...
           {
           dispose();
           ShowQuestion7 frame = new ShowQuestion7();
           frame.setVisible(true);
     ...
     public static void main(String[] args) {
       ...
       ShowQuestion11  frame = new ShowQuestion11();
